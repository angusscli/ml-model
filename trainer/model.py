...
CSV_COLUMNS = ['rise', 'good_num', 'bad_num', 'neutral_num']
...
INPUT_COLUMNS = [
    ...
    tf.feature_column.numeric_column('good_num'),
    tf.feature_column.numeric_column('bad_num'),
    tf.feature_column.numeric_column('neutral_num'),
]
...
def build_estimator(config, embedding_size=8, hidden_units=None):
  ...
  """
  (good_num, bad_num, neutral_num) = INPUT_COLUMNS
  # Build an estimator.
